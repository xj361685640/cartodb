...
module.exports = {
  ...
  cartodb3: {
    options: {
      ...
      specs: [
        '.grunt/builder-generic-specs.js',
        '.grunt/builder-components-specs.js',
        '.grunt/builder-data-specs.js',
        '.grunt/builder-dataset-specs.js',
        '.grunt/builder-editor-specs.js',
        '.grunt/builder-helpers-specs.js'
      ],
