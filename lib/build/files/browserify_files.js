...
module.exports = {
  ...
  // ----------------------- //
  // Splitting Builder specs //
  // ----------------------- //
  'builder-generic-specs': {
    src: [
      'lib/build/source-map-support.js',
      'lib/assets/test/spec/cartodb3/*.spec.js',
      'lib/assets/test/spec/node_modules/**/*.spec.js'
    ],
    dest: '.grunt/builder-generic-specs.js'
  },

  'builder-components-specs': {
    src: [
      'lib/assets/test/spec/cartodb3/components/**/*.spec.js'
    ],
    dest: '.grunt/builder-components-specs.js'
  },

  'builder-data-specs': {
    src: [
      'lib/assets/test/spec/cartodb3/data/**/*.spec.js'
    ],
    dest: '.grunt/builder-data-specs.js'
  },

  'builder-dataset-specs': {
    src: [
      'lib/assets/test/spec/cartodb3/dataset/**/*.spec.js'
    ],
    dest: '.grunt/builder-dataset-specs.js'
  },

  'builder-editor-specs': {
    src: [
      'lib/assets/test/spec/cartodb3/editor/**/*.spec.js'
    ],
    dest: '.grunt/builder-editor-specs.js'
  },

  'builder-helpers-specs': {
    src: [
      'lib/assets/test/spec/cartodb3/helpers/**/*.spec.js'
    ],
    dest: '.grunt/builder-helpers-specs.js'
  }
};
