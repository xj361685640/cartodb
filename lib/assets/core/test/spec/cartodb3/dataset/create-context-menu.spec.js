...
describe('dataset/create-context-menu', () => {
  it('should provide all options when user is owner', () => {
  ...
  it('should not provide any option except duplicate', () => {
    var view = createContextMenu({
      ev: {},
      isTableOwner: false,
      isSync: false,
  ...
  it('should not provide rename option if is synced', () => {
    var view = createContextMenu({
      ev: {},
      isTableOwner: true,
      isSync: true,
