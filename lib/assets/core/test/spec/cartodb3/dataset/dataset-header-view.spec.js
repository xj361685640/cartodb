...
describe('dataset/dataset-header-view', () => {
  beforeEach(() => {
    jest.Ajax.install();
    jest.Ajax.stubRequest(new RegExp('^http(s)?.*map.*'))
    ...
    var router = jest.createSpyObj('router', ['navigate']);
    var modals = jest.createSpyObj('modals', ['create', 'isOpen']);
  ...
  describe('render', () => {
    it('should render the inline editor view', () => {
    ...
    it('should not render the inline editor view but sync table info', () => {
      spyOn(this.view._userModel, 'isInsideOrg').and.returnValue(true);
    ...
    it('should not render the inline editor if owner is different', () => {
      spyOn(this.view._userModel, 'isInsideOrg').and.returnValue(true);
    ...
    it('should not render the sync info if owner is different', () => {
      spyOn(this.view._userModel, 'isInsideOrg').and.returnValue(true);
      this.view._tableModel.isOwner.and.returnValue(false);
      this.tableModel.isSync.and.returnValue(true);
      this.view.render();
    ...
    it('should render privacy dropdown when user doesn\'t belong to an organization', () => {
    ...
    it('should render read permission tag if user can only read the dataset', () => {
  ...
  describe('binds', () => {
    it('should change table name when vis name changes', () => {
    ...
    it('should not open privacy link if user is not owner', () => {
      this.view._tableModel.isOwner.and.returnValue(false);
      this.view.render();
      this.view.$('.js-privacy').click();
    ...
    it('should render when synchronization has been destroyed', () => {
      HeaderView.prototype.render.calls.reset();
