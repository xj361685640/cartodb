...
describe('dataset/dataset-options-view', () => {
  beforeEach(() => {
  ...
  it('should render properly when edition', () => {
  ...
  it('should fetch geometry when a query is applied', () => {
  ...
  it('should remove ; character from the query if it is in the last position', () => {
    this.view._codemirrorModel.set('content', 'select * from whatever;');
    this.view._parseSQL();
  ...
  it('should render preview button if geometry exists', () => {
  ...
  it('should respond to change dataset name', () => {
