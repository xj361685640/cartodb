...
describe('NodeGeometryTracker.track', () => {
  beforeEach(() => {
    ...
    this.analysisDefinitionsCollection.saveAnalysisForLayer = () => {};
  ...
  it('should save analysis if node geometry changes', () => {
  ...
  it('should not save analysis for the layer if node is source type', () => {
    var nodeDefModel = this.analysisDefinitionNodesCollection.at(0);
    var layerDefModel = this.layerDefinitionsCollection.at(0);
    nodeDefModel.set({
      simple_geom: 'line',
