...
describe('deep-insights-integrations/edit-feature-overlay', () => {
  beforeEach(() => {
  ...
  describe('when click', () => {
    ...
    it('should not launch modal', () => {
      expect(this.view._confirmStopEdition).not.toHaveBeenCalled();
    });
  });

  describe('when layer is editable', () => {
    beforeEach(() => {
      spyOn(this.view._featureDefinition, 'isEditable').and.returnValue(true);
      this.view.render();
    });
    ...
    describe('when user is not owner and has write access', () => {
      beforeEach(() => {
        this.view.render();
      });
    ...
    describe('when feature is too big', () => {
      beforeEach(() => {
      ...
      it('should launch modal', () => {
        expect(this.view._confirmStopEdition).toHaveBeenCalled();
      });
    });
  });

  describe('when layer is not editable', () => {
    beforeEach(() => {
    ...
    describe('when layer has analysis', () => {
      beforeEach(() => {
    ...
    describe('when layer has custom SQL', () => {
      beforeEach(() => {
    ...
    describe('when layer is read-only', () => {
      beforeEach(() => {
