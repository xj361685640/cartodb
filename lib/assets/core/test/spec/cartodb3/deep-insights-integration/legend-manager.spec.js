...
describe('deep-insights-integrations/legend-manager', () => {
  beforeEach(() => {
  ...
  describe('points', () => {
    describe('without autostyle', () => {
      ...
      it('styles color category quantification', () => {
        this.styleModel.set('fill', {
          color: {
            attribute: 'number',
            attribute_type: 'number',
    ...
    describe('with autostyle', () => {
      ...
      it('styles color', () => {
        ...
        expect(LegendFactory.removeLegend).toHaveBeenCalledWith(this.layerDefinitionModel, 'custom_choropleth', jest.any(Function));
        expect(LegendFactory.createLegend.calls.count()).toBe(2);
        expect(LegendFactory.createLegend).toHaveBeenCalledWith(this.layerDefinitionModel, 'bubble', {title: 'number', fillColor: '#ffc6c4'});
        expect(LegendFactory.createLegend).toHaveBeenCalledWith(this.layerDefinitionModel, 'choropleth', {title: 'number'});
      });
  ...
  describe('custom legend', () => {
    ...
    it('styles color doesn\'t create a new color legend', () => {
      this.styleModel.set('fill', {
        color: {
          attribute: 'number',
          attribute_type: 'number',
