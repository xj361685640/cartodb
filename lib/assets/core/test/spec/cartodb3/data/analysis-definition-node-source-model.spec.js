...
describe('cartodb3/data/analysis-definition-node-source-model', () => {
  beforeEach(() => {
  ...
  describe('.getDefaultQuery', () => {
    ...
    it('should provide a default query without qualifing if user does not belong to an organization', () => {
    ...
    it('should provide a default query with qualifing if user does belong to an organization', () => {
      this.userModel.isInsideOrg.and.returnValue(true);
      this.model.tableModel.getOwnerName.and.returnValue('pericoo');
      expect(this.model.getDefaultQuery()).toBe('SELECT * FROM pericoo.bar');
    });

    it('should provide a default query with qualifing if user does belong to an organization and is not the owner', () => {
      this.userModel.isInsideOrg.and.returnValue(true);
  ...
  describe('.isReadOnly', () => {
    ...
    it('should be true if table-model is read-only', () => {
    ...
    it('should be false if table-model is not read-only and custom query is not applied', () => {
      this.model.tableModel.isReadOnly.and.returnValue(false);
  ...
  describe('setTableName', () => {
    it('should set the new table name in several objects', () => {
