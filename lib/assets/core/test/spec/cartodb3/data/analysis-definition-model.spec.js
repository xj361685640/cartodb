...
describe('data/analysis-definition-model', () => {
  beforeEach(() => {
  ...
  describe('.containsNode', () => {
    ...
    it('should return true if given node is contained in the analysis', () => {
    ...
    it('should return false if the analysis has no node', () => {
  ...
  describe('.toJSON', () => {
    it('should return serialized model with custom options', () => {
