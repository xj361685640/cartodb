...
describe('data/layer-definitions-collection', () => {
  beforeEach(() => {
  ...
  describe('.add', () => {
    it('should not have created source nodes for layers that have non-sources', () => {
      this.collection.add({
        id: 'A',
        kind: 'carto',
        options: {
    ...
    it('should create source if it matches expected source node id', () => {
      this.collection.add({
        id: 'A',
        kind: 'carto',
        options: {
  ...
  it('should create the layer with the next letter representation available but only for data layers', () => {
  ...
  it('should create the layer with the color that corresponds to the letter', () => {
    var layersData = [
      { kind: 'tiled', order: 0 }, // a basemap
      { kind: 'carto', order: 1 },
      { kind: 'carto', order: 2 },
  ...
  it('should create a layer with the owner of the table in the query', () => {
  ...
  describe('.save', () => {
    ...
    it('should order and save the entire collection when all analysis definitions have been created', () => {
      var options = {};
  ...
  describe('.getNumberOfDataLayers', () => {
    it('should return the number of CartoDB and Torque layers', () => {
  ...
  describe('.findPrimaryParentLayerToAnalysisNode', () => {
    beforeEach(() => {
    ...
    it('should return a parent layer if given node is a direct node below a node in another layer', () => {
    ...
    it('should not return anything if found layer should be excluded', () => {
      var a2 = this.analysisDefinitionNodesCollection.get('a2');
    ...
    it('should not return anything if given node has no parent layer immediate above it', () => {
  ...
  describe('layers position methods', () => {
    beforeEach(() => {
      this.collection.reset([
        { kind: 'tiled' },
        { kind: 'carto' },
  ...
  describe('.setBaseLayer', () => {
    beforeEach(() => {
      ...
      this.changingBaseLayerCallback = jest.createSpy('changingBaseLayer');
      this.baseLayerChangedCallback = jest.createSpy('baseLayerChanged');
      this.baseLayerFailedCallback = jest.createSpy('baseLayerFailed');
    ...
    describe('when trying to set the same baseLayer', () => {
      beforeEach(() => {
        this.collection.reset([
          {
            kind: 'tiled',
      ...
      it('should trigger events', () => {
        var changingBaseLayerCallback = jest.createSpy('changingBaseLayer');
        var baseLayerChangedCallback = jest.createSpy('baseLayerChanged');
    ...
    it('should unset previous base layer attributes that are not present in the new layer (eg: urlTemplate)', () => {
      ...
      expect(Backbone.sync).toHaveBeenCalledWith(
        ...
        jest.objectContaining({ silent: true, wait: true })
      );
    ...
    describe("when the current baseLayer doesn't have labels", () => {
      beforeEach(() => {
        this.collection.reset([
          {
            id: '1',
      ...
      describe("when the new baseLayer doesnt't have labels", () => {
        beforeEach(() => {
          this.collection.setBaseLayer({
            type: 'Tiled',
            name: 'Dark matter',
        ...
        it('should trigger a "changingBaseLayer event', () => {
          expect(this.changingBaseLayerCallback.calls.count()).toEqual(1);
        });

        it('should save the existing base layer', () => {
          expect(Backbone.Model.prototype.save.calls.count()).toEqual(1);
        });

        describe('when the base layer is saved', () => {
          beforeEach(() => {
          ...
          it('should update the base layer', () => {
          ...
          it('should trigger a "baseLayerChanged" event', () => {
            expect(this.baseLayerChangedCallback.calls.count()).toEqual(1);
          });
        });

        describe('when the base layer is NOT saved', () => {
          beforeEach(() => {
            Backbone.sync.calls.argsFor(0)[2].error();
          });

          it('should trigger a "baseLayerFailed" event', () => {
            expect(this.baseLayerFailedCallback).toHaveBeenCalled();
          });
        });
      });

      describe('when the new baseLayer has labels', () => {
        beforeEach(() => {
          this.collection.setBaseLayer({
            type: 'Tiled',
            name: 'Dark matter',
        ...
        it('should save the existing baseLayer', () => {
          expect(Backbone.Model.prototype.save.calls.count()).toEqual(1);
        });
        ...
        describe('when the base layer is saved', () => {
          ...
          describe('when the labels layer is saved', () => {
            beforeEach(() => {
            ...
            it('should create the labels layer', () => {
            ...
            it('should add the layer to the collection', () => {
              expect(this.collection.size()).toEqual(2);
            });
          });

          describe('when the labels layer is NOT saved', () => {
            beforeEach(() => {
            ...
            it('should NOT add the layer to the collection', () => {
              expect(this.collection.size()).toEqual(1);
            });
          });
        });
        ...
        describe('when the base layer is NOT saved', () => {
          ...
          it('should NOT create the labels layer', () => {
            expect(Backbone.Model.prototype.save.calls.count()).toEqual(1);
            expect(this.collection.size()).toEqual(1);
          });
    ...
    describe('when the current baseLayer has labels', () => {
      beforeEach(() => {
        this.collection.reset([
          {
            id: '1',
      ...
      describe("when the new baseLayer doesnt't have labels", () => {
        ...
        describe('when the base layer is saved', () => {
          ...
          it('should remove the labels layer', () => {
            expect(Backbone.Model.prototype.destroy).toHaveBeenCalled();
          });

          describe('when the labels layer is destroyed', () => {
            beforeEach(() => {
              Backbone.sync.calls.argsFor(1)[2].success();
            });
            ...
            it('should remove the layer from the collection', () => {
              expect(this.collection.size()).toEqual(1);
            });
          });

          describe('when the labels layer is NOT destroyed', () => {
            beforeEach(() => {
              Backbone.sync.calls.argsFor(1)[2].error();
            });
            ...
            it('should NOT remove the layer from the collection', () => {
              expect(this.collection.size()).toEqual(2);
            });
          });
        });
      ...
      describe('when the new baseLayer has labels', () => {
        ...
        describe('when the base layer is saved', () => {
          ...
          describe('when the labels layer is saved', () => {
            ...
            it('should update the labels layer', () => {
              expect(this.collection.last().toJSON()).toEqual({
                id: '2',
                kind: 'tiled',
                options: {
        ...
        describe('when the base layer is NOT saved', () => {
          ...
          it('should NOT update the labels layer', () => {
