...
describe('data/legends/legend-definitions-collection', () => {
  ...
  it('should search by layerDefModel properly', () => {
  ...
  it('should search by type properly', () => {
    var layerDefModel = layerDefCollection.at(0);
  ...
  it('should search by types properly', () => {
