...
describe('data/legends/legend-custom-defintion-model', () => {
  beforeEach(() => {
  ...
  describe('inheritStyleCategories', () => {
    it('should return proper output when fixed provided', () => {
      var color = {
        fixed: '#fabada',
        image: 'icon.svg'
      };
    ...
    it('should return proper output when range provided', () => {
      var color = {
