...
describe('cartodb3/data/widget-definition-model', () => {
  beforeEach(() => {
  ...
  it('should have a url pointing to layers API endpoint', () => {
  ...
  it('should flatten the structure on parse', () => {
  ...
  it('should set some defaults in addition to the provided data', () => {
    expect(this.widgetDefModel.attributes).toEqual(
      jest.objectContaining({
  ...
  describe('.toJSON', () => {
    ...
    it('should include expected attrs', () => {
  ...
  describe('.changeType', () => {
    ...
    it('should have new relevant attrs', () => {
    ...
    it('should remove attrs of no interest anymore', () => {
  ...
  describe('.containsNode', () => {
    ...
    it('should return true if widget depends on given node', () => {
    ...
    it('should return false if widget source does not exist', () => {
