...
describe('data/widget-definitions-collection', () => {
  beforeEach(() => {
  ...
  describe('when a model is created', () => {
    ...
    it('should set a new order when a new widget is created', () => {
  ...
  describe('autoStyle', () => {
    ...
    it('should update widgets autostyle when layer\'s style changes', () => {
