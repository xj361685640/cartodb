...
describe('data/layer-colors', () => {
  describe('.getColorForLetter', () => {
    it('should return the first color if no letter is given', () => {
      expect(layerColors.getColorForLetter()).toEqual(layerColors.COLORS[0]);
    });

    it('should return the color for the given letter', () => {
