...
describe('data/infowindow-definition-model', () => {
  describe('model', () => {
    var model;
    ...
    it('should allow adding an alternative name', () => {
      model.addField('name');
    ...
    it('should add a field in order', () => {
    ...
    it('should allow modify field properties', () => {
      model.addField('test');
    ...
    it('should empty fields if template is none', () => {
      model.addField('test');
