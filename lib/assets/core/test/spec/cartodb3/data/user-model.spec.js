...
describe('data/user-model', () => {
  ...
  it("shouldn't set avatar_url is it comes with null value", () => {
  ...
  it('should answer if user can create new datasets', () => {
  ...
  describe('.upgradeContactEmail', () => {
    ...
    describe('when us a organization user', () => {
      ...
      describe('when user is a normal organization member', () => {
        ...
        it('should return the organiation owner email', () => {
  ...
  describe('.nameOrUsername', () => {
    it('should return the name or username as fallback if name is not available', () => {
