...
describe('common/background-polling/import-model', () => {
  beforeEach(() => {
  ...
  it('should create a sync import when there\'s no interval', () => {
    spyOn(this.model, '_createSyncImport');
    spyOn(this.model, '_createRegularImport');
  ...
  it('should create a regular import when interval is 0', () => {
    spyOn(this.model, '_createSyncImport');
    spyOn(this.model, '_createRegularImport');
  ...
  it('should stop polling when import post fails', () => {
  ...
  it('should start polling when item_queue_id is set', () => {
    spyOn(this.model, 'pollCheck');
