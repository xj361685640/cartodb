...
describe('common/background-polling/imports-model', () => {
  beforeEach(() => {
    ...
    this.model._importModel.createImport = () => {};
    this.model._importModel.pollCheck = () => {};
  });
  ...
  it('should change state when upload or import state change', () => {
  ...
  it('should return is import has failed', () => {
  ...
  it('should return is import has been completed', () => {
  ...
  it('should be able to return import info', () => {
    this.model._importModel.createImport = () => {};
    this.model.set('id', 'vamos-neno');
  ...
  it('should be able to return upload info', () => {
    this.model._importModel.createImport = () => {};
  ...
  describe('checkStatus', () => {
    ...
    it('should stop process when upload is not valid', () => {
    ...
    it('should not stop process when upload is not valid but there is an id already set', () => {
      this.model._uploadModel.set({
        type: 'url',
        value: ''
      });
    ...
    it('should start upload when type is file', () => {
      this.model._uploadModel.set({
        type: 'file',
    ...
    it('should create an import when type is not file and there is no id defined', () => {
      this.model._uploadModel.set({
        type: 'url',
        value: 'http://paco.com'
      });
  ...
  describe('upload model', () => {
    ...
    it('should have progress, change:value and error/invalid binds', () => {
    ...
    it('should set uploading state when progress change', () => {
    ...
    it('should have a fileAttribute set', () => {
      expect(this._uploadModel.fileAttribute).toBe('filename');
    });

    it('should validate the model when changes', () => {
    ...
    it('should add error code when size validation fails', () => {
    ...
    it('should raise an error when file name is not provided', () => {
      this._uploadModel.set({
        type: 'file',
        value: { }
      });
    ...
    describe('.setFresh', () => {
      ...
      it('should set the given dataset', () => {
        expect(this._uploadModel.set).toHaveBeenCalled();
        expect(this._uploadModel.set.calls.argsFor(0)[0]).toEqual(jest.objectContaining({ foo: 'bar' }));
      });

      it('should omit the create_vis value since set in constructor', () => {
        expect(this._uploadModel.set.calls.argsFor(0)[0]).not.toEqual(jest.objectContaining({ create_vis: true }));
      });
    });
  });
});
