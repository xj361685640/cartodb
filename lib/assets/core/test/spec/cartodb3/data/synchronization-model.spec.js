...
describe('data/synchronization', () => {
  ...
  describe('JSON stringification', () => {
    it("should return guessing parameters, interval and URL when it doesn't come from a service", () => {
      this.syncModel.set({
    ...
    it('should return the right params when it comes from a remote source', () => {
      this.syncModel.set({
        type: 'remote',
    ...
    it('should add service attributes when it comes from a service', () => {
      this.syncModel.set({
  ...
  describe('linkToTable', () => {
    it('should assign id from table it exists and not fetch', () => {
  ...
  it('should set failure state if there is any error', () => {
