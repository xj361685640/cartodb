...
describe('data/query-rows-collection', () => {
  beforeEach(() => {
  ...
  describe('setTableName', () => {
    it('should not change tableName when it is renamed but it is not referenced', () => {
    ...
    it('should change tableName from itself and its children when it is renamed', () => {
      this.collection.reset([{ id: 'hola' }]);
  ...
  describe('._initBinds', () => {
    it('should change status and reset data when query-schema-model query changes', () => {
  ...
  describe('.isFetching', () => {
    it('should change "state" when is fetched', () => {
    ...
    it('should change "state" when fetch has finished', () => {
      this.collection.fetch();
      expect(this.collection.isFetching()).toBeFalsy();
      expect(this.collection.isFetched()).toBeTruthy();
    });

    it('should change "state" when fetch has failed', () => {
      this.collection.sync = function (a, b, opts) {
        opts && opts.error();
      };
      this.collection.fetch();
