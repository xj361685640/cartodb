...
describe('data/query-schema-model', () => {
  beforeEach(() => {
  ...
  describe('when there is no query set initially', () => {
  ...
  it('should setup status according to given query and status attrs when model is created', () => {
  ...
  describe('.resetDueToAlteredData', () => {
    it('should change status, trigger an event and fetch', () => {
      var spyObj = jest.createSpy('resetDueToAlteredData');
  ...
  describe('.fetch', () => {
    ...
    describe('when called with default', () => {
      beforeEach(() => {
        this.model.fetch();
      });
      ...
      it('should use default request params', () => {
    ...
    describe('when called with custom attrs set', () => {
      beforeEach(() => {
        this.model.set({
          page: 1,
          rows_per_page: 40,
      ...
      it('should use custom request params', () => {
        this.model.set({
          page: 1,
          rows_per_page: 40,
          sort_order: 'desc'
  ...
  describe('.hasDifferentSchemaThan', () => {
    it('should return false when schema is the same', () => {
      var sameSchema = [
        {
          name: 'cartodb_id',
          type: 'number'
    ...
    it('should return false when compared schema is empty', () => {
    ...
    it('should return true when compared schema has any different column', () => {
      var comparingSchema = [
        {
          name: 'heyyy'
        }, {
    ...
    it('should return false when a column doesn\'t contain the type', () => {
      this.model.columnsCollection.reset([
        {
          name: 'cartodb_id',
          type: 'number'
  ...
  describe('.hasDefaultQueryFor', () => {
    it('should return false if no query is applied', () => {
      this.model.unset('query');
