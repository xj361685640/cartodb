...
describe('data/query-columns-collection', () => {
  beforeEach(() => {
  ...
  describe('binds', () => {
    it('should fetch query schema model when new column is added', () => {
    ...
    it('should take query-schema when status changes to fetched', () => {
  ...
  describe('addColumn', () => {
    it('should wait and not parse the new column', () => {
      var options = {};
      var attributes;
