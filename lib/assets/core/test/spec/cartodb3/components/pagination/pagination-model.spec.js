...
describe('components/pagination/pagination-model', () => {
  describe('.pagesCount', () => {
    describe('given there are no items', () => {
      ...
      it('should return at least one page', () => {
        expect(this.m.pagesCount()).toEqual(1);
      });
    });

    describe('given there are less items than per page', () => {
      beforeEach(() => {
        this.m = new PaginationModel({
          total_count: 6,
          per_page: 7
      ...
      it('should return that there is just one page', () => {
        expect(this.m.pagesCount()).toEqual(1);
      });
    });

    describe('given there are one more item than per page', () => {
      beforeEach(() => {
        this.m = new PaginationModel({
          total_count: 4,
          per_page: 3
      ...
      it('should return the upper amount of pages', () => {
  ...
  describe('.pagesToDisplay', () => {
    describe('given there are less pages than expected to be visible', () => {
      beforeEach(() => {
        this.m = new PaginationModel({
          total_count: 30,
          per_page: 10,
      ...
      it('should return a sequence of integers starting from first page to the last available page', () => {
        expect(this.m.pagesToDisplay()).toEqual([1, 2, 3]);
      });
    });

    describe('given there are more pages than expected to be visible', () => {
      beforeEach(() => {
        this.m = new PaginationModel({
          total_count: 130,
          per_page: 10,
      ...
      describe('when current page is with the first visible pages', () => {
        it('should return a sequence of integers relative to current page', () => {
      ...
      describe('when current page is within lower threshold for extras', () => {
        it('should display additional pages too since they are still within the sequence', () => {
      ...
      describe('when current page is in the middle range of available pages', () => {
        it('should return a sequence of pages with additional pages separated by undefined', () => {
      ...
      describe('when current page is reach threshold', () => {
        it('should display additional pages too since they are still within the sequence', () => {
      ...
      describe('when current page is within the upper threshold for extras', () => {
        it('should return a sequence of integers of the last visible pages', () => {
  ...
  describe('.isCurrentPage', () => {
    ...
    it('should return true if given page is current', () => {
  ...
  describe('.hasUrl', () => {
    ...
    it('should return true if there is a url_to method set', () => {
      ...
      expect(this.newModel({ url_to: () => {} }).hasUrl()).toBeTruthy();
    });
  });
});
