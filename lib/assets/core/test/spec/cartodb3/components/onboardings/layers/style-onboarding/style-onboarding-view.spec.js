...
describe('components/onboardings/layers/style-onboarding/style-onboarding-view', () => {
  ...
  describe('_onChangeStep', () => {
    it('should call prototype function before anything else', () => {
      this.view = this.getView();
      var calls = [];
      spyOn(this.view, '_setMiddlePad').and.callFake(() => {
        calls.push('_setMiddlePad');
      });
      spyOn(Object.getPrototypeOf(Object.getPrototypeOf(this.view)), '_onChangeStep').and.callFake(() => {
    ...
    it('should call proper functions in each step', () => {
      this.view = this.getView();
  ...
  describe('_setStepOne', () => {
    it('should highlight `.js-styleNoGeom` if present', () => {
    ...
    it('should highlight aggregation panels if the onboarding has three steps', () => {
      this.view = this.getView();
    ...
    it('should highlight style panel if the onboarding has two steps', () => {
      this.view = this.getView();
  ...
  describe('_setStepTwo', () => {
    it('should highlight options bar if the onboarding has two steps', () => {
      this.view = this.getView();
      this.view._numberOfSteps = 2;
      spyOn(this.view, '_highlightOptionsBar');
    ...
    it('should highlight style panel if the onboarding has three steps', () => {
      this.view = this.getView();
      this.view._numberOfSteps = 3;
      spyOn(this.view, '_highlightStyleProperties');
  ...
  describe('_highlightStyleProperties', () => {
    it('should call `_setMiddlePad` with proper values', () => {
      this.view = this.getView();
      spyOn(this.view, '_setMiddlePad');
  ...
  describe('_getAggregationPositionAndPadding', () => {
    it('should return `js-aggregationTypes` position if no aggregation options are present', () => {
      this.view = this.getView();
    ...
    it('should return `js-aggregationTypes` plus `aggregationOptions` height and additional padding', () => {
      this.view = this.getView();
      var aggTypesPanel = helper.addElement('js-aggregationTypes', 40, 50, 60, 70);
