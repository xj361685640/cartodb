...
describe('components/onboardings/layers/data-onboarding/data-onboarding-view', () => {
  ...
  describe('_onChangeStep', () => {
    ...
    it('should call `_setMiddlePad` with the proper values in each step', () => {
      this.view = this.getView();
  ...
  describe('_getFeatureEditionPosition', () => {
    it('should retrieve `.js-mapTableView` position if no feature edition is present', () => {
      this.view = this.getView();
    ...
    it('should retrieve the container of `.js-mapTableView` and `.js-newGeometryView`', () => {
      this.view = this.getView();
      var mapTableButton = helper.addElement('js-mapTableView', 40, 50, 60, 70);
