...
describe('components/onboardings/layers/analysis-onboarding/analysis-onboarding-view', () => {
  beforeEach(() => {
  ...
  describe('._onAddAnalysisClicked', () => {
    it('should clean this view and click on global addAnalysis button', () => {
