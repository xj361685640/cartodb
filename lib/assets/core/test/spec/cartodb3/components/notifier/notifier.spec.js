...
describe('components/notifier/notifier', () => {
  var editorModel;

  beforeEach(() => {
    editorModel = new Backbone.Model();
    editorModel.isEditing = () => { return false; };
  ...
  it('should return the view properly', () => {
    expect(Notifier.getView()).toBeDefined();
  });

  it('should set collection properly', () => {
    expect(this.model.collection).toBeDefined();
  });

  it('model should retrigger vis events', () => {
    var spy = jest.createSpy('spy');
  ...
  it('should return the proper model', () => {
  ...
  it('should search model properly', () => {
  ...
  it('should remove two o more views created at the same time', () => {
    var n1 = Notifier.addNotification({
      status: 'success',
      info: 'First',
      closable: true
  ...
  it('should remove notification properly', () => {
    var result = Notifier.getNotification('whatever');
