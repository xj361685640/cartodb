...
describe('components/pagination-search/pagination-search-view', () => {
  var view;
  var fn;
  var collection;
  ...
  describe('pagination', () => {
    ...
    it('should bind pagination properly', () => {
