...
var simulateEscapeKeyPress = () => {
  var e = $.Event('keydown');
  e.keyCode = e.which = ESCAPE_KEY_CODE;
  $(document).trigger(e);
};

describe('components/context-menu/context-menu-view', () => {
  beforeEach(() => {
    var self = this;
  ...
  it('should be toggled when clicking on an element inside of the triggerElement', () => {
    expect(this.view.$el.css('display')).toEqual('none');
  ...
  it('should be hidden when clicking on the document', () => {
    this.triggerElement.click();
  ...
  it('should be hidden when hitting ESCAPE', () => {
    this.triggerElement.click();
  ...
  it('should be hidden when clicking on one of the items', () => {
    this.triggerElement.click();
  ...
  it('should not try to hide the context menu when clicking somewhere else', () => {
  ...
  it('should not try to hide the context menu when ESC key is pressed', () => {
    spyOn(this.view, 'hide');
    simulateEscapeKeyPress();
    expect(this.view.hide).not.toHaveBeenCalled();
    this.view.show();
  ...
  describe('.clean', () => {
    ...
    it('should unbind document clicks', () => {
      spyOn(this.view, 'hide');
