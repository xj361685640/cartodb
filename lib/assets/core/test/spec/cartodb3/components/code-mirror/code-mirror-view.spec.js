...
function fakeCodeMirrorKey (cm, type, code, props) {
  ...
  var e = {type: type, keyCode: code, preventDefault: () => {}, stopPropagation: () => {}};
...
describe('components/code-mirror/code-mirror-view', () => {
  ...
  it('should bind change:content properly', () => {
    this.createView();
  ...
  it('should bind change:readonly properly', () => {
    this.createView();
  ...
  it('should show autocomplete on demand', () => {
    this.createView();
  ...
  describe('autocompletePrefix', () => {
    ...
    describe('._completeIfAfterCtrlSpace', () => {
      it('should show autocomplete on demand', () => {
        this.view.editor.setValue('');
