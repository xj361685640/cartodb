...
describe('components/custom-list/custom-list-search-view', () => {
  ...
  describe('.binds', () => {
    ...
    it('should submit form on key pressed in the text input', () => {
      spyOn(this.view, '_submit');
      this.view.$('input').trigger('keyup');
      expect(this.view._submit).toHaveBeenCalled();
    });

    it('should check buttons when query changes', () => {
    ...
    it('should remove query when clear is pressed', () => {
