...
describe('components/custom-list/custom-view', () => {
  beforeEach(() => {
  ...
  it('should generate internal collection and model', () => {
  ...
  describe('render', () => {
    ...
    it('should render list and search view by default', () => {
    ...
    it('should not render search view if showSearch is disabled', () => {
  ...
  describe('on change visibility', () => {
    ...
    it('should reset query attribute, toggle the visibility and render', () => {
      expect(this.view._toggleVisibility).toHaveBeenCalled();
      expect(this.view.model.get('query')).toBe('');
      expect(this.view.render).toHaveBeenCalled();
    });

    it('should clear subviews when visibility changes to false', () => {
