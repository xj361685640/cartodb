...
describe('components/custom-list/custom-list-view', () => {
  beforeEach(() => {
  ...
  describe('with free text input', () => {
    ...
    it('should render the add message when there are no items', () => {
  ...
  describe('render', () => {
    ...
    it('should apply the custom scroll and the arrows binding', () => {
      jest.clock().tick(100);
  ...
  describe('arrow + ENTER bindings', () => {
    beforeEach(() => {
      this.view.render();
    });

    it('should highlight next (first) item when arrow key is pressed', () => {
    ...
    it('should highlight prev (last) item when arrow key is pressed', () => {
    ...
    it('should select current highlighed item when ENTER is pressed', () => {
  ...
  it('should remove bindings when view is cleaned', () => {
  ...
  it('should remove bindings properly', () => {
  ...
  it('should highlight selected value on show', () => {
