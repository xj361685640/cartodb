...
describe('editor/components/background-importer/background-import-item', () => {
  beforeEach(() => {
  ...
  it('should show display_name when it is available from import model', () => {
