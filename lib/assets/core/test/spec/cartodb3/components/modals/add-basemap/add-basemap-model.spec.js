...
describe('components/modals/add-basemap/add-basemap-model', () => {
  beforeEach(() => {
  ...
  it('should start with tabs for current view', () => {
    expect(this.model.get('contentPane')).toEqual('tabs');
  });

  it('should start on XYZ tab', () => {
    expect(this.model.get('currentTab')).toEqual('xyz');
  });

  describe('.activeTabModel', () => {
    it('should return the model for current tab', () => {
      expect(this.model.activeTabModel()).toEqual(jest.any(Object));
    });
  });

  describe('.canSaveBasemap', () => {
    it('should return true if there is a layer set on current tab model and is not processing something', () => {
  ...
  describe('.saveBasemap', () => {
    ...
    describe('when layer has already been added', () => {
      beforeEach(() => {
    ...
    describe('when layer is new', () => {
      ...
      describe('when save fails', () => {
        ...
        it('should remove layer from baselayers', () => {
          expect(this.customBaselayersCollection.contains(this.layer)).toBeFalsy();
        });

        it('should set current view to addBasemapFailed', () => {
