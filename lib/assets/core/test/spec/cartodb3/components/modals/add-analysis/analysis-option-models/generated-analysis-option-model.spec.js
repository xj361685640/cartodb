...
describe('cartodb3/components/modals/add-analysis/analysis-option-models/generated-analysis-option-model', () => {
  beforeEach(() => {
  ...
  describe('when created a type with a single source', () => {
    beforeEach(() => {
  ...
  describe('when created a type with multiple input sources', () => {
    beforeEach(() => {
      this.model = new GeneratedAnalysisOptionModel({
    ...
    describe('.getFormAttrs', () => {
      it('should return attrs but w/o any source set', () => {
        expect(this.model.getFormAttrs(this.layerA)).toEqual({
          id: 'a1',
          type: 'aggregate-intersection'
        });
