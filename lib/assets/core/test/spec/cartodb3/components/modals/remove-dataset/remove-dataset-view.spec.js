...
describe('modals/remove-dataset-view', () => {
  ...
  function createView (options) {
    ...
    if (organizationAffected) {
      ...
      _.times(numberOfDependentEntities, () => {
  ...
  describe('render', () => {
    it('Nothing affected, visualization and entities sections not shown', () => {
      // Arrange
      view = createView();
    ...
    it('1 visualization affected. Visualization gets properly rendered.', () => {
      // Arrange
    ...
    it('More vis affected than AFFECTED_VIS_COUNT. Text changed to extended one.', () => {
      // Arrange
    ...
    it('Organization affected. Proper text and avatar rendered.', () => {
      // Arrange
      var userNode;
    ...
    it('1 user affected. Proper text and avatar rendered.', () => {
      // Arrange
      var userNode;
      var affectedEntity;
    ...
    it('More user affected than AFFECTED_ENTITIES_SAMPLE_COUNT. Text changed to extended.', () => {
      // Arrange
    ...
    it('Affected entity repeated. Repeated entity gets filtered.', () => {
      // Arrange
      view = createView({
    ...
    it('Affected group. Users of that group get rendered.', () => {
      // Arrange
      view = createView({
        affectedGroup: true
      });
  ...
  describe('_runAction', () => {
    it('Renders loading view and destory has been set to the right success function.', () => {
      // Arrange
      var successFunction;
      view = createView();
    ...
    it('Destroy has been set to the right error function.', () => {
      // Arrange
      var errorFunction;
      view = createView();
  ...
  it('_renderLoadingView inserts the right HTML', () => {
    // Arrange
    view = createView();
  ...
  it('_onErrorDestroyDataset inserts the right HTML', () => {
    // Arrange
    view = createView();
