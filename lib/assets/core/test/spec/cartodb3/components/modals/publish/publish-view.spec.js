...
describe('components/modals/publish/publish-view', () => {
  var view;
  var userModel;

  beforeEach(() => {
    jest.Ajax.install();
    jest.Ajax.stubRequest(new RegExp('^http(s)?.*grantables.*'))
  ...
  it('should render properly in share in single mode', () => {
    view.mode = 'share';
    view.render();
  ...
  it('should render properly for users without organization', () => {
