...
describe('editor/components/modals/add-basemap/wms/select-layer-view', () => {
  beforeEach(() => {
  ...
  describe('when there are a bunch of layers and some unavailable ones', () => {
    beforeEach(() => {
    ...
    it('should render the amount of layers', () => {
    ...
    it('should render the individual items', () => {
  ...
  describe('when click back', () => {
    beforeEach(() => {
      this.view.$('.js-back').click();
    });

    it('should set current view to go back to enter URL', () => {
