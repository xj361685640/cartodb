...
describe('editor/components/modals/add-basemap/wms/wms-layer-view', () => {
  beforeEach(() => {
  ...
  it('should render item title or name', () => {
  ...
  it('should not disable any item by default', () => {
    expect(this.innerHTML).not.toContain('is-disabled');
  });

  describe('when can not save layer', () => {
    beforeEach(() => {
