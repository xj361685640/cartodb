...
describe('components/modals/add-widgets/layer-selector-view', () => {
  beforeEach(() => {
    ...
    this.layerDefinitionModel1.getName = this.layerDefinitionModel2.getName = () => {
  ...
  it('should render table name and node id in the selected item', () => {
    expect(this.view).toBeDefined();
    expect(this.view.$el.html()).toContain('foo');
    expect(this.view.$el.html()).toContain('a1');
  });

  it('should render table name and node id in the custom list items', () => {
