...
describe('components/modals/publish/share-with-view', () => {
  var view;
  var userModel;
  ...
  describe('render', () => {
    ...
    it('should render properly when inside org', () => {
    ...
    it('should render properly when inside org and has an action', () => {
      userModel._organizationModel = new Backbone.Model({
        id: 1
      });

      view.options.action = jest.createSpy('actionCallback');
