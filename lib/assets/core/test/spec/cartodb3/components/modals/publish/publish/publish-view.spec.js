...
describe('components/modals/publish/publish/publish-view', () => {
  var view;
  ...
  it('should render properly when published and private', () => {
  ...
  it('should render properly when published and public', () => {
    mapcapsCollection.reset([{
      created_at: '2016-06-21T15:30:06+00:00'
    }]);
