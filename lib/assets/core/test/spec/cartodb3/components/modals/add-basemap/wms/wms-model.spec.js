...
describe('editor/components/modals/add-basemap/wms/wms-model', () => {
  beforeEach(() => {
  ...
  it('should not have any layers initially', () => {
    expect(this.model.wmsLayersCollection.length).toEqual(0);
  });

  it('should have enter URl as initial view', () => {
  ...
  describe('.fetchLayers', () => {
    ...
    it('should fetch layers from given URL', () => {
    ...
    it('should change view to indicate that layers are being fetched', () => {
      expect(this.model.get('currentView')).toEqual('fetchingLayers');
    });

    describe('when fetch is done', () => {
      describe('when there are layers', () => {
        beforeEach(() => {
          this.model.wmsLayersCollection.sync = function (a, b, opts) {
            opts.success({
              layers: [{}, {}, {}],
        ...
        it('should change view to select layer', () => {
          expect(this.model.get('currentView')).toEqual('selectLayer');
        });
      });

      describe('when there are no layer', () => {
        beforeEach(() => {
          this.model.wmsLayersCollection.sync = function (a, b, opts) {
            opts.success({
              layers: [],
        ...
        it('should change view back to enter URL', () => {
          expect(this.model.get('currentView')).toEqual('enterURL');
        });

        it('should indicate that layers were fetched', () => {
  ...
  describe('when a layer changes state', () => {
    beforeEach(() => {
    ...
    it('should set the current view appropriately', () => {
    ...
    it('should select layer if state is done', () => {
