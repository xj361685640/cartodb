...
describe('components/modals/dataset-metadata/dataset-metadata-view', () => {
  beforeEach(() => {
  ...
  it('._getMetadataName sanitizes input', () => {
  ...
  it('._getMetadataDescription sanitizes input', () => {
  ...
  it('._getMetadataTags sanitizes input', () => {
