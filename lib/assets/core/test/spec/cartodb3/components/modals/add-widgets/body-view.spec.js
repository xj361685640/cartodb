...
describe('components/modals/add-widgets/body-view', () => {
  beforeEach(() => {
    var layerDefinitionModel = new Backbone.Model();
    layerDefinitionModel.getName = () => { return 'layer'; };
  ...
  it('should create tab pane items when there is at least one option of that type', () => {
