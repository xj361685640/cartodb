...
describe('editor/export-image-pane/export-image-pane', () => {
  beforeEach(() => {
    ...
    this.getStaticImageURL = jest.createSpy('getStaticImageURL');
    ...
    this.mapDefinitionModel.latLngToPixel = () => {
      return { x: 100, y: 20 };
    };
    ...
    // mocks
    this.view._loadLogo = () => { return true; };
    this.view._loadAttribution = () => { return true; };
  ...
  it('should call the method to generate the image', () => {
    this.view.$('.js-ok').click();
  ...
  describe('validation', () => {
    it('should disable save button if validation error', () => {
    ...
    it('should validate when dimensions change manually', () => {
      this.view._exportImageFormView._formView.fields.width.setValue(30000);
      this.view._exportImageFormView._formView.trigger('change');
      expect(this.view.$('.js-ok').attr('disabled')).toBe('disabled');
  ...
  describe('with google maps', () => {
    ...
    it('should generate the gmaps url', () => {
    ...
    it('should call the google method to generate the image', () => {
    ...
    describe('validation', () => {
      ...
      it('should disable save button if validation error with premium user', () => {
