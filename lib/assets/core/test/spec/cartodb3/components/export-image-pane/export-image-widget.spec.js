...
describe('editor/export-image-pane/export-image-widget', () => {
  beforeEach(() => {
  ...
  it('should have tracking classes', () => {
  ...
  it('should update coordinates on state changes', () => {
