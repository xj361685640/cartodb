...
describe('components/form-components/editors/fill/input-color/input-categories/input-color-categories', () => {
  ...
  it('should hide the title label back arrow', () => {
  ...
  describe('._createColorPickerView', () => {
    it('should set picker view opacity to 1 when no opacity is provided', () => {
    ...
    it('should set picker view opacity to the value provided', () => {
      var opacity = 0.83;
    ...
    it('should subscribe to picker view change of opacity', () => {
  ...
  describe('._updateRangeAndDomain', () => {
    var MAX_VALUES = 10; // Mirror the constant from input-color-categories.js

    it('the color for "others" category is the proper one', () => {
