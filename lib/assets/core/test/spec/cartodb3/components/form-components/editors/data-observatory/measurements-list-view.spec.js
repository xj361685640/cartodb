...
describe('components/form-components/editors/data-observatory/measurement-list-view', () => {
  beforeEach(() => {
  ...
  it('should render filtered measurements', () => {
  ...
  it('should trigger filter event', () => {
