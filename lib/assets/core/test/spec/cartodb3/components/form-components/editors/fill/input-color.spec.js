...
describe('components/form-components/editors/fill/input-color', () => {
  var svgResponse = {
    status: 200,
  ...
  describe('range', () => {
    ...
    it('should update when the value has changed', () => {
    ...
    it('should set opacity for each color', () => {
      this.model.set({
  ...
  describe('image', () => {
    describe('without image enabled', () => {
    ...
    describe('with image enabled', () => {
      describe('without image', () => {
        it('should render image link if category images are present', () => {
          this.view = new InputColor(({
            model: new Backbone.Model({
              opacity: 0.5,
              fixed: fixed,
        ...
        it('should not render image link if category images are not present', () => {
          this.view = new InputColor(({
            model: new Backbone.Model({
              opacity: 0.5,
              fixed: fixed,
      ...
      describe('with image', () => {
        ...
        beforeEach(() => {
          jest.Ajax.install();
          jest.Ajax.stubRequest(new RegExp('^http(s)?.*/image.svg'))
        ...
        it('SVG should have been loaded', () => {
        ...
        it('._updateImageColor should change fill attribute', () => {
