...
describe('components/form-components/editors/fill/input-color/asset-picker/assets-list-view', () => {
  ...
  describe('.initialize', () => {
    it('should call ._setupAssets and get assets with default options if no options provided', () => {
      this.createView();
    ...
    it('should call ._setupAssets and get assets with provided options', () => {
      this.createView({
        folder: 'a folder',
        size: 48,
        host: 'a host',
    ...
    it('should limit asset collection length if limit option is present', () => {
      this.createView({
        limit: 2
      });
  ...
  describe('render', () => {
    it('should render icons according to the template', () => {
      this.createView();
  ...
  describe('._selectItem', () => {
    it('should select given item and deselect the others', () => {
