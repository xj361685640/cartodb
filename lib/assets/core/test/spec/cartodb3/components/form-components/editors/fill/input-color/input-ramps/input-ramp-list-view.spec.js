...
describe('components/form-components/editors/fill/input-color/input-ramps/input-ramp-list-view', () => {
  describe('with a default ramp', () => {
    beforeEach(() => {
    ...
    it('should select ramp on click', () => {
    ...
    it('should update ramps on attribute type changes and select the first one', () => {
  ...
  describe('with a custom ramp', () => {
    ...
    it('should select the custom ramp', () => {
      this.view.$('.js-listItemLink:eq(0)').click();
      this.view.$('.js-customRamp').click();
      expect(this.view.$('.js-customRamp').hasClass('is-selected')).toBeTruthy();
    });

    it('should start the customization process clicking on the customized ramp again', () => {
      var customizeEventTriggered = false;

      this.view.$('.js-listItemLink:eq(0)').click();
      this.view.$('.js-customRamp').click();

      this.view.bind('customize', () => {
    ...
    it('should clear the custom ramp', () => {
