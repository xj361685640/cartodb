...
describe('components/form-components/editors/fill/color-picker/color-picker', () => {
  ...
  describe('withouth opacity', () => {
    ...
    it('should disable the opacity selector', () => {
      expect(this.view.$('.js-a').val()).toBe('0.5');
    ...
    it('should change the hex color directly', () => {
    ...
    it('should change each color individually', () => {
    ...
    it('should change each the alpha', () => {
