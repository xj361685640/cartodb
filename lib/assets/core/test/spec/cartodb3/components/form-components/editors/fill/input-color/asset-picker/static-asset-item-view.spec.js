...
describe('components/form-components/editors/fill/input-color/asset-picker/static-asset-item-view', () => {
  beforeEach(() => {
  ...
  describe('initialize', () => {
    it('should bind change:state that toggles selected', () => {
  ...
  describe('._onClick', () => {
    it('should kill event, trigger selected and change model state', () => {
