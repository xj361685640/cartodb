...
describe('components/form-components/editors/fill/input-color/assets-picker/user-assets-list-view', () => {
  beforeEach(() => {
  ...
  it('should trigger an upload event when clicking the add button', () => {
    var triggered = false;

    this.view.bind('init-upload', () => {
      triggered = true;
    }, this);
  ...
  it('should select all the assets', () => {
  ...
  it('should deselect all the assets', () => {
    this._userAssetCollection.at(0).set('state', 'selected');
  ...
  describe('when user is inside organization', () => {
    var view;
    ...
    it('should select an asset and deselect all the organization assets', () => {
  ...
  it('should remove selected assets', () => {
    this._userAssetCollection.at(0).set('state', 'selected');
    this._userAssetCollection.at(1).set('state', 'selected');
    this._userAssetCollection.at(2).set('state', '');
  ...
  it('should unset the selected asset', () => {
    var self = this;

    AssetModel.prototype.destroy = () => {
