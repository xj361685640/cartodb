...
describe('components/form-components/editors/data-observatory/dropdown-view', () => {
  ...
  it('should genereate an measurements and filters collections', () => {
    this.createView();
  ...
  it('should change button value and hide dialog when a new item is selected', () => {
    this.createView();
  ...
  it('should destroy dialog when element is removed', () => {
    this.createView();
