...
describe('components/form-components/operators/operators-list-view', () => {
  beforeEach(() => {
  ...
  it('should generate an internal model with the options', () => {
  ...
  it('should destroy list if hidden', () => {
  ...
  describe('.render', () => {
    ...
    it('should render list when operator is different than count', () => {
  ...
  describe('._onModelChange', () => {
    it('should trigger change when new value is selected and is valid', () => {
      spyOn(this.view, 'trigger');
      this.view.model.set({ operator: 'avg', attribute: '¥' });
      expect(this.view.trigger).toHaveBeenCalled();
    });

    it('should not trigger change when new value is selected and is not valid', () => {
      spyOn(this.view, 'trigger');
      this.view.model.set({ operator: 'avg', attribute: '' });
  ...
  it('should destroy list view when it is removed', () => {
    this.view.remove();
    expect(this.view._hasList()).toBeFalsy();
  });
});
