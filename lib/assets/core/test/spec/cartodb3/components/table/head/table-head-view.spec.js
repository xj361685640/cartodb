...
describe('components/table/head/table-head-view', () => {
  beforeEach(() => {
    ...
    this.analysisDefinitionNodeModel.isReadOnly = () => {
      return false;
    };
  ...
  describe('render', () => {
    ...
    it('should render as many columns as column collection items has', () => {
  ...
  describe('binds', () => {
    ...
    it('should render when table view model changes its sort', () => {
      this.tableViewModel.set('sort_order', 'desc');
      expect(this.view.render).toHaveBeenCalled();
    });

    it('should render when table view model changes its order', () => {
      this.tableViewModel.set('order_by', 'description');
      expect(this.view.render).toHaveBeenCalled();
    });

    it('should render when simple geometry has changed', () => {
      this.queryGeometryModel.set('simple_geom', 'polygon');
      expect(this.view.render).toHaveBeenCalled();
    });

    it('should scroll to left when a new element is added', () => {
      jest.clock().install();
