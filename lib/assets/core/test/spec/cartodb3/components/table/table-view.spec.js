...
describe('components/table/table-view', () => {
  beforeEach(() => {
  ...
  describe('fetch', () => {
    it('should fetch query-schema-model if it is unfetched', () => {
      expect(QuerySchemaModel.prototype.fetch).toHaveBeenCalled();
    });

    it('should fetch rows data if query-schema-model is already fetched', () => {
    ...
    it('should not fetch rows data if query-schema-model query modifies the schema', () => {
      spyOn(TableView.prototype, '_fetchRowsData');
  ...
  describe('render', () => {
    ...
    it('should render head and body', () => {
  ...
  describe('bind', () => {
    it('should reset table view attributes when query has changed', () => {
    ...
    it('should include sort and order if the query is custom but the change comes from table-view-model', () => {
    ...
    it('should check disabled state each time query schema model changes', () => {
      this.querySchemaModel.set('status', 'fetched');
    ...
    it('should fetch query-schema-model if query has changed and it is possible', () => {
    ...
    it('should fetch new rows when query fetch has finished', () => {
      this.querySchemaModel.set('status', 'fetched');
      expect(QueryRowsCollection.prototype.fetch).toHaveBeenCalled();
    });

    it('should render again if synchronization is destroyed', () => {
    ...
    describe('on table model view changes', () => {
      beforeEach(() => {
        this.querySchemaModel.set('status', 'fetched');
      ...
      it('should fetch new rows when table order changes', () => {
        this.view._tableViewModel.set('order_by', 'cartodb_id');
        expect(QueryRowsCollection.prototype.fetch).toHaveBeenCalled();
      });

      it('should fetch new rows when table sort changes', () => {
  ...
  describe('.getColumnsCollection', () => {
    it('should provide the _columnsCollection object', () => {
