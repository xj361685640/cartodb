...
describe('editor/components/modals/export-map/modal-export-map-view', () => {
  beforeEach(() => {
    ...
    spyOn(this.view, '_renderCompleteView').and.callFake(() => {
  ...
  describe('render', () => {
    it('should render confirmation view if state is undefined', () => {
    ...
    it('should render pending view when pending state', () => {
      var state = 'pending';
    ...
    it('should render uploading view when uploading', () => {
      var state = 'uploading';
    ...
    it('should render exporting view when exporting', () => {
      var state = 'exporting';
    ...
    it('should render complete view when complete', () => {
    ...
    it('should render error view when failure', () => {
