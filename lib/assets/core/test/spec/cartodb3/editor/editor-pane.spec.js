...
describe('editor/editor-view', () => {
  ...
  it('should create PanelWithOptionsView with selector for onboarding', () => {
  ...
  it('should have two subviews', () => {
    expect(_.size(this.view._subviews)).toBe(2);
  });

  describe('._onLayerCollectionAdd', () => {
    it('should fetch visualization privacy if a new layer is added', () => {
  ...
  describe('add button', () => {
    ...
    it('should be displayed when there are items on the selected tab', () => {
    ...
    it('should be hidden when an item is removed', () => {
      this.widgetDefinitionsCollection.add(this.widgetDefModel);
