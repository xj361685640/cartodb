...
describe('editor/style/style-form/style-shape-properties-form-model', () => {
  describe('.parse', () => {
    beforeEach(() => {
    ...
    it('should not provide fill size if geometry type is polygon or style aggregated', () => {
    ...
    it('should not provide fill if geometry type is line', () => {
      var attrs = StyleShapePropertiesFormModel.prototype.parse(
        this.generateData('simple', 'polygon')
      );
    ...
    it('should not provide stroke and blending if type is heatmap', () => {
      var attrs = StyleShapePropertiesFormModel.prototype.parse(
