...
describe('editor/style/style-form/style-labels-properties-form-view', () => {
  beforeEach(() => {
  ...
  describe('bindings', () => {
    it('should disabled subform when animated is enabled', () => {
  ...
  describe('render', () => {
    it('should include enabler from the beginning', () => {
    ...
    it('should render subform depending enabler state', () => {
    ...
    it('should not render help message if geometry is not point', () => {
