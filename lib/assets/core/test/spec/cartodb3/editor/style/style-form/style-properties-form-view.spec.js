...
describe('editor/style/style-form/style-properties-form-view', () => {
  beforeEach(() => {
    var self = this;
  ...
  describe('.render', () => {
    ...
    it('should apply proper form step number', () => {
    ...
    it('should show shape and labels forms', () => {
    ...
    it('should show unanimatable view if animated and no numeric or dates columns', () => {
    ...
    it('should not display labels option if heatmap style is selected', () => {
    ...
    it('should not display animated option if dataset geometry is not points', () => {
      this.changeGeometryType('polygon');
      this.view.render();
      expect(_.size(this.view._subviews)).toBe(2);
    ...
    it('should not display animated option if styles are aggregated', () => {
      spyOn(this.styleModel, 'isAggregatedType').and.returnValue(true);
      this.view.render();
      expect(_.size(this.view._subviews)).toBe(2);
      expect(this.view.$el.html()).not.toContain('editor.style.components.animated-enabled');
