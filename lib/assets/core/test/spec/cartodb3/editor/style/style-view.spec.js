...
describe('editor/style/style-view', () => {
  beforeEach(() => {
    jest.Ajax.install();
  ...
  it('should show infobox if layer is hidden', () => {
  ...
  it('should append existing Maps API errors to codemirror model when view is initialized', () => {
  ...
  describe('bindings', () => {
    it('should set codemirror value when style model changes', () => {
    ...
    it('should set codemirror value when the cartocss is changed', () => {
      spyOn(this.view._codemirrorModel, 'set');
    ...
    it('should append Maps API errors to existing codemirror errors', () => {
  ...
  it('should not save cartocss if content is empty', () => {
    var content = '';
    spyOn(this.layerDefinitionModel, 'save');
  ...
  describe('._launchOnboarding', () => {
    describe('when queryRowsCollection is not fetched', () => {
      beforeEach(() => {
      ...
      it('should wait until it is fetched', () => {
    ...
    describe('when queryRowsCollection is fetched', () => {
      beforeEach(() => {
      ...
      it('should do nothing if it is editing', () => {
      ...
      it('should do nothing if it can be georeferenced', () => {
        this.view._onboardingNotification.setKey(layerOnboardingKey, false);
      ...
      it('should do nothing if it doesn\'t have geometry', () => {
        this.view._onboardingNotification.setKey(layerOnboardingKey, false);
