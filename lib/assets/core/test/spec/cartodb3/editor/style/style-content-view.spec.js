...
describe('editor/style/style-content-view', () => {
  beforeEach(() => {
    ...
    this.view = new StyleContentView({
      ...
      freezeTorgeAggregation: jest.createSpy('freezeTorgeAggregation')
    });
  ...
  describe('._initBinds', () => {
    it('should render when query schema is fetched', () => {
    ...
    it('should not render when query schema is loading/fetching', () => {
      StyleContentView.prototype.render.calls.reset();
      this.querySchemaModel.set('status', 'fetching');
    ...
    it('should render when styleModel is undone or redone', () => {
      StyleContentView.prototype.render.calls.reset();
  ...
  describe('.render', () => {
    it('should render "placeholder" if state is loading', () => {
    ...
    it('should render properly when models are fetched and have selector for onboarding', () => {
    ...
    it('should not render carousel view when geometry is not point', () => {
      this.view.modelView.set({state: 'ready'});
      this.querySchemaModel.set('status', 'fetched');
      this.queryGeometryModel.set({
        status: 'fetched',
    ...
    it('should not render _renderForm when data has no geometry', () => {
      this.view.modelView.set({state: 'ready'});
      this.querySchemaModel.set('status', 'fetched');
      this.queryGeometryModel.set({
        status: 'fetched',
    ...
    it('should have correct class for onboarding when showing the placeholder', () => {
  ...
  describe('on style changed', () => {
    ...
    it('should remove autogenerated attribute', () => {
      expect(this.model.get('autogenerated')).toBeFalsy();
    });

    it('should remove styles pre autostyle if autostyle', () => {
    ...
    it('should not change cartocss_custom property when styleModel changes', () => {
  ...
  describe('autoStyle', () => {
    it('render on autostyle changes', () => {
