...
describe('editor/style/style-form/style-form-view', () => {
  beforeEach(() => {
  ...
  describe('.render', () => {
    ...
    it('should render none message when style type is none', () => {
    ...
    it('should render aggregation form if type is aggregated', () => {
