...
describe('editor/editor-header', () => {
  beforeEach(() => {
    ...
    var onClickPrivacy = jest.createSpy('onClickPrivacy');
    var onRemoveMap = jest.createSpy('onRemoveMap');
  ...
  it('should call duplicate when duplicate option is clicked', () => {
