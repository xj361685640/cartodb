...
describe('editor/widgets/widgets-form/widgets-form-factory', () => {
  var userModel = {
  ...
  describe('data form', () => {
    describe('formula data form', () => {
      ...
      it('should generate the widget form model', () => {
    ...
    describe('time-series data form', () => {
      beforeEach(() => {
        this.widgetDefinitionModel = new WidgetDefinitionModel({
          layer_id: 'w-456',
          title: 'some title',
  ...
  describe('type validation', () => {
    ...
    describe('data validation', () => {
      it('should return the valid widget types for string columns', () => {
      ...
      it('should return the valid widget types for numeric columns', () => {
        this.querySchemaModel.columnsCollection.reset([
      ...
      it('should return the valid widget types for date columns', () => {
        this.querySchemaModel.columnsCollection.reset([
          { name: 'year', type: 'date' }
        ]);
