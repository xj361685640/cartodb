...
describe('editor/widgets/widgets-form/widgets-form-view', () => {
  beforeEach(() => {
  ...
  it('should update form model when widgetDefinitionModel rename', () => {
    this.widgetDefinitionModel.set({title: 'wadus'});
    expect(this.view._formView._widgetFormModel.get('title')).toBe('wadus');
  });

  it('should have enabler editor component for suffix and prefix, disable by default', () => {
  ...
  it('should include widget style fields if needed', () => {
    // formula widget
  ...
  it('should save widget definition when widget type has changed', () => {
