...
describe('editor/widgets/widgets-form/schema/widgets-form-base-schema-model', () => {
  var userModel = {
  ...
  it('should transform sync values to values that the form interprets as expected', () => {
  ...
  describe('.changeWidgetDefinitionModel', () => {
    beforeEach(() => {
      this.widgetDefinitionModel = new Backbone.Model();
      spyOn(this.widgetDefinitionModel, 'set');
    });

    it('should set the expected values for the sync values', () => {
    ...
    it('should set the expected values for category and autostyle', () => {
    ...
    it('should set the expected values for histogram and autostyle', () => {
