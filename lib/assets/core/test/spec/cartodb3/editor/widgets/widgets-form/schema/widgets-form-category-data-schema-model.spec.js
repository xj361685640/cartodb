...
describe('editor/widgets/widgets-form/schema/widgets-form-category-schema-model', () => {
  beforeEach(() => {
  ...
  describe('.updateSchema', () => {
    ...
    it('should contain the real columns as options', () => {
      expect(this.model.schema.column.options[0].label).toEqual('col');
    });

    it('should not contain aggregation column if the aggregation is "count"', () => {
