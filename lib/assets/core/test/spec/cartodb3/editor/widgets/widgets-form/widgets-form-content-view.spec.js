...
describe('editor/widgets/widgets-form/widgets-form-content-view', () => {
  beforeEach(() => {
  ...
  it('should generate the right tabs', () => {
  ...
  it('should get back to the previous step if arrow is clicked', () => {
