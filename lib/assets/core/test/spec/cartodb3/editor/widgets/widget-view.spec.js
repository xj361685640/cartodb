...
describe('editor/widgets/widget-view', () => {
  var model;
  var view;
  var layer;
  ...
  it('should contain js-widgetItem class', () => {
    expect(view.$el.hasClass('js-widgetItem')).toBeTruthy();
  });

  it('should add a data attribute with the model cid', () => {
  ...
  describe('when clicking on remove', () => {
    it('should remove widget with WidgetsService', () => {
  ...
  it('should edit widget with WidgetsService', () => {
