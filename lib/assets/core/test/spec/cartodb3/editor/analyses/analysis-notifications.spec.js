...
describe('AnalysisNotifications.track', () => {
  beforeEach(() => {
  ...
  describe('if there is an existing notification for the node', () => {
    beforeEach(() => {
      spyOn(Notifier, 'getNotification').and.returnValue(this.notification);
    });

    describe('status changes', () => {
      it('should update the notification if analysis is pending', () => {
      ...
      it('should update the notification if analysis is running', () => {
      ...
      it('should update the notification if analysis is waiting', () => {
      ...
      it('should update the notification if analysis succeeded', () => {
      ...
      it('should update the notification if analysis failed', () => {
    ...
    describe('when an analysis node is deleted', () => {
      ...
      it('should not update the notification if avoidNotification', () => {
  ...
  describe('if there is NO notification for the node', () => {
    _.each(['pending', 'waiting', 'failed'], function (status) {
      it('should display a notification if node has a ' + status + ' status initially', () => {
        this.analysisNode = new Backbone.Model({ id: 'a1' });
    ...
    it('should NOT display a notification if node has a ready status initially', () => {
      this.analysisNode = new Backbone.Model({ id: 'a1' });
      this.analysisNode.set({
        status: 'ready'
      });
    ...
    describe('status changes', () => {
      ...
      describe('when an analysis node has errors', () => {
        it('should update the notification if analysis failed and has errors', () => {
          this.analysisNode.set({
        ...
        it('should update the notification if analysis failed and has errors in error_message', () => {
          this.analysisNode.set({
