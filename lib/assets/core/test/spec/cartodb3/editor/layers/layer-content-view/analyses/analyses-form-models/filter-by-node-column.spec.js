...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/filter-by-node-column', () => {
  ...
  describe('type filter by node column', () => {
    beforeEach(() => {
      this.createModel({
        filter_source: 'a0',
        column: null,
    ...
    describe('filter_column', () => {
      it('validator is correct', () => {
        ...
        expect(this.model.schema.filter_column.validators[1]).toEqual(jest.any(Function));
      });
    });

    describe('._validateFilterColumn', () => {
