...
describe('editor/layers/layer-analyses-view', () => {
  beforeEach(() => {
  ...
  describe('given a layer definition with only its own source', () => {
    beforeEach(() => {
  ...
  describe('given a layer definition with an analysis within its own layer', () => {
    beforeEach(() => {
      this.analysisDefinitionNodesCollection.add({
        id: 'b1',
        type: 'trade-area',
    ...
    describe('given a layer definition with an analysis referencing the head of other layer', () => {
      beforeEach(() => {
        this.analysisDefinitionNodesCollection.add({
          id: 'c1',
          type: 'trade-area',
      ...
      it('should render the own source node', () => {
        expect(this.view.$el.text()).toContain('c1');
        expect(this.view.$el.text()).toContain('analyses.area-of-influence');
      });

      it('should render the source of the other layer but not more', () => {
        expect(this.view.$el.text()).toContain('b1');
