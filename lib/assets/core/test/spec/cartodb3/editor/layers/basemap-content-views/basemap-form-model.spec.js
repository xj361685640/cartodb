...
describe('editor/layers/basemap-content-views/basemap-form-model', () => {
  beforeEach(() => {
  ...
  describe('when form data changes', () => {
    ...
    it('should save changes if it is already selected', () => {
    ...
    it('should not save changes if it is not selected', () => {
