...
describe('editor/layers/layer-header-view', () => {
  ...
  var FakeNodeModel = function (tableModel, synced, syncModel) {
    ...
    if (tableModel) {
      this.tableModel.isSync = () => {
        return synced || false;
      };
      this.tableModel._syncModel = syncModel;
      this.tableModel.getSyncModel = () => {
        return syncModel;
      };
      this.tableModel.isOwner = () => { return true; };
    }
  };
  ...
  describe('.render', () => {
    it('should have class for onboarding', () => {
    ...
    it('should show zoom icon when there is geometry and it should have a tooltip', () => {
      createView.call(this, {});
    ...
    it('should hide zoom icon when there is no geometry', () => {
      createView.call(this, {
        simple_geom: ''
      });
  ...
  describe('._addSyncInfo', () => {
    beforeEach(() => {
      createView.call(this, {});
    });

    it('should call _createSyncInfo with the proper argument if the node has a synced tableModel', () => {
    ...
    it('should not call _createSyncInfo if the node has not a synced tableModel', () => {
    ...
    it('should not call _createSyncInfo if the node does not have a tableModel', () => {
      this.nodeModelSpy.and.returnValue(new FakeNodeModel());
      spyOn(this.view, '_createSyncInfo');
  ...
  describe('._createSyncInfo', () => {
    it('should create SyncInfoView object with proper table and sync models', () => {
      createView.call(this, {});
  ...
  describe('._bindEvents', () => {
    it('should call _onSourceChanged when layer definition model changes source', () => {
      createView.call(this, {});
    ...
    it('should call _showOrHideZoomVisibility when zoom visibility changes', () => {
      createView.call(this, {
        simple_geom: ''
      });
  ...
  describe('._onSourceChanged', () => {
    it('should bind to geometry changes', () => {
      createView.call(this, {});
    ...
    it('should call _checkIfGeometryVisible', () => {
      createView.call(this, {});
  ...
  describe('._isQueryGeometryVisible', () => {
    it('should return false is there is no simple geom', () => {
      createView.call(this, {});
    ...
    it('should return true is there is simple geom', () => {
      createView.call(this, {
        simple_geom: ''
      });
  ...
  describe('._checkIfGeometryVisible', () => {
    it('should set zoomVisible to false is there is no simple geom', () => {
      createView.call(this, {});
    ...
    it('should set zoomVisible to true is there is simple geom', () => {
      createView.call(this, {
        simple_geom: ''
      });
  ...
  describe('._changeStyle', () => {
    it('should have proper classes if editing in expert mode', () => {
    ...
    it('should have proper classes if not in expert mode', () => {
      createView.call(this, {});
      this.view.render();
  ...
  describe('._onZoomClicked', () => {
    it('should call to zoomToData with the right query', () => {
      createView.call(this, {});
  ...
  describe('._showOrHideZoomVisibility', () => {
    it('should show zoom icon if there is geometry', () => {
      createView.call(this, {});
      this.view.render();
    ...
    it('should hide zoom icon if there is not geometry', () => {
      createView.call(this, {
        simple_geom: ''
      });
      this.view.render();
