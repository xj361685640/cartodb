...
describe('editor/layers/basemap-content-view', () => {
  beforeEach(() => {
  ...
  it('should update header if baseLayer changes', () => {
  ...
  it('should update select if category changes', () => {
  ...
  it('should update disabled if model changes', () => {
  ...
  describe('when selected basemap changes', () => {
