...
describe('editor/layers/layer-content-view/analyses/analyses-service', () => {
  beforeEach(() => {
  ...
  describe('.addGeoreferenceAnalysis', () => {
    it('should add a georeference analysis', () => {
  ...
  describe('.addAnalysis', () => {
    ...
    it('should open a modal add-analysis-view', () => {
    ...
    describe('when modal is closed', () => {
      ...
      it('should redirect stack to layer-content', () => {
