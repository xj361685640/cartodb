...
describe('editor/layers/layer-content-view/infowindow/infowindows-view', () => {
  beforeEach(() => {
  ...
  describe('when layer has infowindowModel', () => {
    beforeEach(() => {
    ...
    it('should fetch (if necessary) all query objects', () => {
      expect(InfowindowsView.prototype._fetchAllQueryObjectsIfNecessary).toHaveBeenCalled();
    });

    it('should render loading view if query-geometry-model is fetching', () => {
    ...
    it('should change tab if infowindow (and tooltip) changes', () => {
      expect(this.view.$('.CDB-NavSubmenu-item:eq(0) .CDB-NavSubmenu-status').text()).toBe('editor.layers.infowindow.style.none');
    ...
    describe('infowindows tabs', () => {
      ...
      it('infowindow should render properly', () => {
    ...
    it('should render placeholder if style model type is aggregated', () => {
    ...
    it('should render placeholder if style model has animated enabled', () => {
      expect(_.size(this.view._subviews)).toBe(2);
      expect(this.view.$('.CDB-Size-huge').length).toBe(0);
    ...
    it('should render placeholder when querySchemaModel is unfetched', () => {
      expect(_.size(this.view._subviews)).toBe(2);
      expect(this.view.$('.CDB-Size-huge').length).toBe(0);
    ...
    it('should render placeholder when has no columns', () => {
      expect(_.size(this.view._subviews)).toBe(2);
      expect(this.view.$('.CDB-Size-huge').length).toBe(0);
  ...
  describe('when layer has no geometry', () => {
    beforeEach(() => {
      this.view = new InfowindowsView({
        configModel: this.configModel,
        editorModel: new EditorModel(),
  ...
  describe('when layer is non georeferenced', () => {
    beforeEach(() => {
  ...
  describe('when layer doesn\'t have infowindowModel (basemap, torque, ...)', () => {
    beforeEach(() => {
