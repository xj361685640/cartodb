...
describe('editor/layers/layer-content-views/legends/form/legend-color-helper', () => {
  it('should return collection category items properly', () => {
    var style = {
      'attribute': 'line',
  ...
  it('should return collection category items properly for choropleth style', () => {
    var style = {
      'attribute': 'line',
  ...
  it('should return single category item properly', () => {
    var style = {
      'fixed': '#d4d438',
      'opacity': 1
    };
  ...
  it('should return bubble properly', () => {
    var style = {
      'fixed': '#d4d438',
      'opacity': 1
    };
  ...
  describe('simpleColor', () => {
    it('should return same output as input in color object provided', () => {
      var color = {
        fixed: '#fabada',
        image: 'icon.svg'
      };
