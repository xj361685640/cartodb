...
describe('editor/layers/analysis-views/composite-layer-analysis-view', () => {
  beforeEach(() => {
  ...
  describe('when secondary source is a source node belonging to another layer', () => {
    beforeEach(() => {
      this.view.render();
    });

    it('should render the own source', () => {
      expect(this.view.$('.js-primary-source').text()).toContain('a1');
      expect(this.view.$('.js-primary-source').text()).toContain('intersection');
    });

    it('should render the secondary source as a reference to the other layer', () => {
  ...
  describe('when secondary source is a (non-source) node belonging to another layer ', () => {
    beforeEach(() => {
      this.analysisDefinitionNodesCollection.add({
        id: 'b1',
        type: 'buffer',
  ...
  describe('when secondary source is a source node belonging to own layer', () => {
    beforeEach(() => {
    ...
    it('should render the secondary source as a source but without the id', () => {
      expect(this.view.$('.js-secondary-source').text()).toContain('second');
    });

    it('should not render the id', () => {
