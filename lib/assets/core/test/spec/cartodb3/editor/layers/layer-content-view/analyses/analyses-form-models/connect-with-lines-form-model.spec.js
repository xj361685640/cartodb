...
describe('editor/layers/layer-content-views/analyses/analysis-form-model/connect-with-lines-form-model', () => {
  beforeEach(() => {
  ...
  describe('type line-source-to-target', () => {
    beforeEach(() => {
  ...
  describe('type line-to-single-point', () => {
    beforeEach(() => {
