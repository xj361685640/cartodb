...
describe('editor/layers/data-layer-view', () => {
  beforeEach(() => {
    ...
    this.layerDefinitionsCollection.save = jest.createSpy('save');
    ...
    this.newAnalysesViewSpy = jest.createSpy('newAnalysesView').and.callFake(function (el) {
    ...
    widgetDefinitionsCollection.widgetsOwnedByLayer = () => { return 0; };
  ...
  it('should render title of layer', () => {
  ...
  it('should be displayed as hidden when layer is hidden', () => {
  ...
  it('should render warning icon when layer doesn\'t have geometry', () => {
  ...
  describe('when layer has an analysis', () => {
    it('should render analysis views', () => {
  ...
  describe('context menu', () => {
    it('should toggle the context-menu box when option is clicked', () => {
    ...
    describe('Delete layer…', () => {
      it('should not be posible to delete a layer if canBeDeletedByUser return false', () => {
      ...
      it('should be posible to delete a layer if canBeDeletedByUser', () => {
  ...
  describe('when title is doubleclicked', () => {
    beforeEach(() => {
      jest.clock().install();
      this.view.$('.js-title').click();
      this.view.$('.js-title').click();
  ...
  describe('when the toggle icon is clicked', () => {
    beforeEach(() => {
  ...
  describe('expanded/collapsed states', () => {
    it('should expand and collapse the layer', () => {
  ...
  describe('._showContextMenu', () => {
    it('should show center map option if geom and clicking on it should call _centerMap', () => {
    ...
    it('should not show center map option if no geom', () => {
  ...
  describe('._centerMap', () => {
    it('should call to zoomToData with query from queryGeometryModel', () => {
