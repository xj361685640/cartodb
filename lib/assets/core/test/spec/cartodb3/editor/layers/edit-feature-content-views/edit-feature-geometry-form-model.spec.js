...
describe('editor/layers/edit-feature-content-views/edit-feature-geometry-form-model', () => {
  beforeEach(() => {
  ...
  describe('when type is point', () => {
    ...
    it('should generate lat lng schema from geometry', () => {
    ...
    describe('when latitude is erroneous', () => {
      it('should return regular error if lat is not a number', () => {
      ...
      it('should return custom error if lat is out of bounds', () => {
    ...
    describe('when longitude is erroneous', () => {
      it('should return regular error if lng is not a number', () => {
      ...
      it('should return custom error if lng is out of bounds', () => {
    ...
    describe('when form data changes', () => {
      it('should update feature model', () => {
      ...
      it('should only update the_geom once when lat and lng change so that changes can be detected', () => {
        expect(this.featureModel.get('the_geom')).toBe('{"type":"Point","coordinates":[0,0]}');
      ...
      it('should set the_geom\'s feature without setting a previous one', () => {
  ...
  describe('when type is not point', () => {
    var formModel;
    var featureModel;
    ...
    describe('schema', () => {
      it('should generate schema from geometry', () => {
      ...
      it('should NOT include copy attr if feature does NOT have the_geom', () => {
