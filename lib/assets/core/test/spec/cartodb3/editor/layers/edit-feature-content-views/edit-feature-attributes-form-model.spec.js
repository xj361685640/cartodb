...
describe('editor/layers/edit-feature-content-views/edit-feature-attributes-form-model', () => {
  beforeEach(() => {
  ...
  it('should generate schema from columns collection, omit reserved columns, and assign default Text type', () => {
  ...
  describe('when there is a column of type string', () => {
    beforeEach(() => {
      this.columnsCollection = new QueryColumnsCollection([
        {
          name: 'cartodb_id',
    ...
    describe('when all values are null', () => {
      var formModel;
    ...
    describe('when not all values are null', () => {
      var formModel;
