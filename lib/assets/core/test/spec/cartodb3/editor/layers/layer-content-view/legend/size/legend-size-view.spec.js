...
describe('editor/layers/layer-content-view/legend/size/legend-size-view', () => {
  beforeEach(() => {
  ...
  it('should render custom html legend infobox properly', () => {
  ...
  it('should render hidden layer infobox properly', () => {
  ...
  it('should render legends-disabled infobox properly', () => {
  ...
  it('should transmit html snippets changes properly', () => {
