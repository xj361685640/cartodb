...
describe('editor/layers/layer-content-view/legend/legends-view', () => {
  beforeEach(() => {
  ...
  describe('.render', () => {
    it('should render loading when geometry is being fetched', () => {
    ...
    it('should render sql error message', () => {
    ...
    it('should render no geometry placeholder when geometry is empty', () => {
