...
describe('cartodb3/editor/layers/layer-view-factory', () => {
  beforeEach(() => {
  ...
  it('should return an instance of BaseTiledLayerView', () => {
  ...
  it('should return an instance of PlainColorLayerView', () => {
    var layerModel = new LayerDefinitionModel({
      type: 'Plain',
      order: 0,
      color: '#FABADA'
  ...
  it('should return an instance of BackgroundImageLayerView', () => {
    var layerModel = new LayerDefinitionModel({
      type: 'Plain',
      order: 0,
  ...
  it('should return an instance of DataLayerView', () => {
    var layerModel = new LayerDefinitionModel({
      type: 'CartoDB',
      order: 1
    }, {
  ...
  it('should return an instance of LabelsLayerView', () => {
    var layerModel = new LayerDefinitionModel({
      type: 'Tiled',
      order: 3
    }, {
