...
describe('editor/layers/basemap-content-views/basemap-select-view', () => {
  beforeEach(() => {
  ...
  describe('select', () => {
    ...
    it('should render mosaic if category is CARTO, or Here', () => {
      this.view = new BasemapSelectView({
        layerDefinitionsCollection: this.layerDefinitionsCollection,
        basemapsCollection: this.basemapsCollection,
    ...
    it('should render mosaic if category is Stamen', () => {
      this.view = new BasemapSelectView({
        layerDefinitionsCollection: this.layerDefinitionsCollection,
        basemapsCollection: this.basemapsCollection,
    ...
    it('should render mosaic if category is Custom', () => {
      this.view = new BasemapSelectView({
        layerDefinitionsCollection: this.layerDefinitionsCollection,
        basemapsCollection: this.basemapsCollection,
    ...
    it('should render mosaic if category is Mapbox', () => {
      this.view = new BasemapSelectView({
        layerDefinitionsCollection: this.layerDefinitionsCollection,
        basemapsCollection: this.basemapsCollection,
    ...
    it('should render form if category is Color', () => {
      this.view = new BasemapSelectView({
        layerDefinitionsCollection: this.layerDefinitionsCollection,
        basemapsCollection: this.basemapsCollection,
