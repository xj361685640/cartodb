...
describe('editor/layers/layers-content-view/data/data-content-view', () => {
  var view;
  ...
  beforeEach(() => {
    ...
    var stackLayoutModel = jest.createSpyObj('stackLayoutModel', ['goToStep']);
    ...
    m0.analysisDefinitionNodeModel = () => { return {id: 'a1'}; };
    ...
    m1.analysisDefinitionNodeModel = () => { return {id: 'a2'}; };
    ...
    m2.analysisDefinitionNodeModel = () => { return {id: 'a3'}; };
  ...
  it('should render "placeholder" if loading', () => {
  ...
  it('should bind events properly', () => {
  ...
  it('should manage time-series properly', () => {
    view._columnsModel.set({render: true});
    expect(view._renderStats).toHaveBeenCalled();
