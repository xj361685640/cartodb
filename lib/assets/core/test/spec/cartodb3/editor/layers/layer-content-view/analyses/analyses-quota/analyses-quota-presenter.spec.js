...
describe('editor/layers/layer-content-view/analyses/analyses-quota/analyses-quota-presenter', () => {
  ...
  it('Hard limit, not enough quota', () => {
    var payload = {
      estimation: 127,
      quotaInfo: {
        blockPrice: 0,
  ...
  it('Hard limit, not quota assigned', () => {
    var payload = {
      estimation: 127,
      quotaInfo: {
        blockPrice: 0,
  ...
  it('Soft limit, not enough quota', () => {
    var payload = {
      estimation: 127,
      quotaInfo: {
        blockPrice: 0,
  ...
  it('Soft limit, not quota assigned', () => {
    var payload = {
      estimation: 127,
      quotaInfo: {
        blockPrice: 0,
