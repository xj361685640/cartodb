...
describe('cartodb3/editor/layers/basemap-content-views/basemap-model-factory.js', () => {
  describe('.createBasemapModel', () => {
    beforeEach(() => {
      var layerDefinitionsCollection = new Backbone.Collection();
      layerDefinitionsCollection.getBaseLayer = () => {
    ...
    _.each(testCases, function (testCase) {
      ...
      it('should create a BasemapModel for ' + basemapCategory + ' basemaps', () => {
