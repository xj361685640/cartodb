...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/fallback-form-model', () => {
  beforeEach(() => {
  ...
  describe('when created for a type with a single source', () => {
    beforeEach(() => {
    ...
    describe('should generate schema from camshaft reference', () => {
      beforeEach(() => {
      ...
      it('should not allow to change source', () => {
        expect(this.model.schema.source.editorAttrs.disabled).toBe(true);
      });
    });

    describe('for a model representing a type which contains params of type array', () => {
      beforeEach(() => {
        this.model.set({
  ...
  describe('when creatd for a type with multple sources', () => {
    beforeEach(() => {
      this.analysisSourceOptionsModel = new AnalysisSourceOptionsModel({fetching: true}, {
        analysisDefinitionNodesCollection: {},
        layerDefinitionsCollection: {},
    ...
    describe('when source options is fetched', () => {
      beforeEach(() => {
