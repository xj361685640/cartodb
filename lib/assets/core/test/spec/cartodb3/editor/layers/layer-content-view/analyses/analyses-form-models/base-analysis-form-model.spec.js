...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/base-analysis-form-model', () => {
  beforeEach(() => {
  ...
  describe('.validate', () => {
    it('should be valid if passing camshaft validation', () => {
    ...
    it('should return errors set through setFormValidationErrors', () => {
      expect(this.model.isValid()).toBe(true);
      expect(this.model.validationError).toBeNull();
      this.changeSpy = jest.createSpy('change');
  ...
  describe('._isFetchingOptions', () => {
    it('should return true if it is fetching options', () => {
      expect(this.model._isFetchingOptions()).toBe(true);
    });
  });

  describe('._getSourceOptionsForSource', () => {
    it('should throw error if no sourceAttrName provided', () => {
      var self = this;
      function wrap () {
    ...
    it('should return source if it is the primary source and ignorePrimarySource is false', () => {
    ...
    it('should return object with isLoading if it is fetching options', () => {
      var sourceAttrName = 'target';
      this.model.set(sourceAttrName, 'the source');
      spyOn(this.model, '_isPrimarySource').and.returnValue(true);
    ...
    it('should return source options if it is fetched', () => {
      var sourceAttrName = 'target';
      this.model.set(sourceAttrName, 'the source');
    ...
    it('should return only source options with type node if it is fetched and onlyNodes option provided', () => {
      var sourceAttrName = 'target';
      this.model.set(sourceAttrName, 'the source');
      this.model._layerDefinitionModel.set('source', 808);
      this.model._analysisSourceOptionsModel.getSelectOptions = () => {};
    ...
    it('should call to getSelectOptions with the right type of geom if option is provided', () => {
      var sourceAttrName = 'target';
      this.model.set(sourceAttrName, 'the source');
      this.model._layerDefinitionModel.set('source', 808);
      this.model._analysisSourceOptionsModel.getSelectOptions = () => {};
    ...
    it('should return the layer source with the options if includeSourceNode param is provided', () => {
      var sourceAttrName = 'target';
      this.model.set(sourceAttrName, 'the source');
