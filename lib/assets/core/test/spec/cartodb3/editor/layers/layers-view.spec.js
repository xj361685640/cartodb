...
describe('editor/layers/layers-view', () => {
  beforeEach(() => {
    jest.Ajax.install();
  ...
  describe('should setup layers list as a sortable', () => {
    beforeEach(() => {
    ...
    it('should set items', () => {
      expect(this.sortableArgs.items).toEqual(jest.any(String));
    });
    ...
    describe('when a layer is moved', () => {
      ...
      it('should move layers from top to bottom', () => {
      ...
      it('should move layers from bottom to top', () => {
    ...
    describe('when an analyses is dropped on sortable list', () => {
      beforeEach(() => {
      ...
      describe('when already reached the max layers limit', () => {
        beforeEach(() => {
        ...
        it('should remove dragged element', () => {
