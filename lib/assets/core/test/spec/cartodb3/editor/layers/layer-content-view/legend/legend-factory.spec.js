...
describe('editor/layers/layer-content-view/legend/legend-factory', () => {
  beforeEach(() => {
    jest.Ajax.install();
  ...
  it('create legend', () => {
    ...
    jest.Ajax.requests.mostRecent().respondWith(getSuccessResponse(1, 'bubble'));

    LegendFactory.createLegend(this.layerDefinitionModel, 'choropleth');
    jest.Ajax.requests.mostRecent().respondWith(getSuccessResponse(2, 'choropleth'));

    LegendFactory.createLegend(this.layerDefinitionModel, 'category');
    jest.Ajax.requests.mostRecent().respondWith(getSuccessResponse(3, 'category'));
  ...
  it('remove legend', () => {
    ...
    jest.Ajax.requests.mostRecent().respondWith(TestResponses.destroy.success);
