...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/georeference-form-model', () => {
  beforeEach(() => {
  ...
  describe('type georeference-street-address', () => {
    ...
    describe('context advance', () => {
      ...
      it('should format street_address properly', () => {
