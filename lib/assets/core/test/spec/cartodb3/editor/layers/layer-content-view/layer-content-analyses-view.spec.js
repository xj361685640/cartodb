...
describe('editor/layers/layer-content-view/layer-content-analyses-view', () => {
  beforeEach(() => {
  ...
  describe('when a new node is added to layer definition', () => {
    ...
    it('should render workflow and analysis form views', () => {
      expect(this.view.$el.html()).not.toContain('placeholder-text');
    });

    it('should have a add-analysis button', () => {
      expect(this.view.$el.html()).toContain('js-add-analysis');
      expect(this.view.$('.js-add-analysis').length).toEqual(1);
      expect(this.view.$('.js-add-analysis').data('layer-id')).toEqual('l-1');
    });

    it('should use default selection (head)', () => {
    ...
    describe('when there is no corresponding analysis yet (e.g. form representing new item)', () => {
      beforeEach(() => {
      ...
      it('should use form as fallback model', () => {
        expect(this.view.$el.html()).toContain('a1'); // should not throw any error
      });
    });
  });

  describe('when a new form model is added', () => {
    beforeEach(() => {
