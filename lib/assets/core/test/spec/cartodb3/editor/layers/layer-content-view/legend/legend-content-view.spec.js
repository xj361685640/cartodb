...
describe('editor/layers/layer-content-view/legend/legend-content-view', () => {
  beforeEach(() => {
  ...
  it('should handle toggle state properly', () => {
    this.view._carouselCollection.at(0).set({selected: true});
  ...
  it('should render form properly when carousel changes', () => {
    this.view._carouselCollection.at(1).set({selected: true});
    expect(LegendContentView.prototype._renderForm).toHaveBeenCalled();
  });

  describe('carousel', () => {
    it('should render carousel styleModel for points based', () => {
      this.layerDefinitionModel.styleModel = new Backbone.Model({
        fill: {
          color: {
    ...
    it('should render carousel styleModel for lines based', () => {
      this.layerDefinitionModel.styleModel = new Backbone.Model({
        stroke: {
          color: {
            attribute: 'n_anclajes',
    ...
    it('should render category legend option in the carousel if styleModel has quantification category', () => {
      this.layerDefinitionModel.styleModel = new Backbone.Model({
        fill: {
          color: {
            attribute: 'n_anclajes',
