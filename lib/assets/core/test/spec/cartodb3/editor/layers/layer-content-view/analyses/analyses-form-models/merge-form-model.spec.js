...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/merge-form-model', () => {
  ...
  beforeEach(() => {
    ...
    this.analysisSourceOptionsModel.find = () => {
      return this;
    };

    this.analysisSourceOptionsModel.filter = () => {
      return [];
    };
  ...
  it('should format the attributes', () => {
    this.createModel();
  ...
  describe('parsing the model', () => {
    ...
    it('should parse the model with right source_geometry', () => {
      var attrs = {
        id: 'a1',
        source: 'a0',
        type: 'merge',
    ...
    it('should parse the model without source_geometry', () => {
      var attrs = {
        id: 'a1',
        source: 'a0',
        type: 'merge',
  ...
  describe('type join columns', () => {
    ...
    it('should include left_source and right_source column', () => {
    ...
    describe('right_source_column', () => {
      it('validator is correct', () => {
        ...
        expect(this.model.schema.right_source_column.validators[1]).toEqual(jest.any(Function));
      });
    });

    describe('._validateRightSourceColumn', () => {
      it('should validate column types match', () => {
        var self = this;
