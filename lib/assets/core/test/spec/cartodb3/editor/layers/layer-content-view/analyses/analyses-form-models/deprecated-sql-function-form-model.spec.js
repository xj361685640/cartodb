...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/deprecated-sql-function-form-model', () => {
  var cdbSQLBackup;
  ...
  describe('._initBinds', () => {
    it('should hook up the proper events', () => {
  ...
  describe('.validate', () => {
    it('should set primary source and serialize function arguments', () => {
      var attrs = 'the attributes';
      var options = 'the options';
      this.formModel.set('source', 'tatooine');
      var calls = [];
      spyOn(this.formModel, '_serializeFunctionArgs').and.callFake(() => {
        calls.push('serialize');
      });
      spyOn(BaseAnalysisFormModel.prototype, 'validate').and.callFake(() => {
        calls.push('validate');
      });
  ...
  describe('.getTemplate', () => {
    it('should return sql function template', () => {
  ...
  describe('.getTemplateData', () => {
    it('should return proper fields of the selected function', () => {
  ...
  describe('.setSchema, ._buildSchema and _addParamToSchema', () => {
    it('should return schema based of selected function params', () => {
      var selectedFunction = 'dep_ext_fakeFunk';
      this.formModel.attributes.function_name = selectedFunction;
      this.formModel._functionsInfo = [{
        functionName: selectedFunction,
    ...
    it('.setSchema should call base form', () => {
  ...
  describe('_onFetchStatusChanged', () => {
    it('should call _setSchema', () => {
      spyOn(this.formModel, '_setSchema');
  ...
  describe('._fetchAvailableFunctions', () => {
    var SQL;
    var SQLcallbacks;
    var queryUsed;
    var trackBackup;
    ...
    it('should fill _functionsInfo if successful', () => {
      var metadata = {
        rows: [{
    ...
    it('should track error if error', () => {
      var errors = {
  ...
  describe('_getSelectFunctionAttrs', () => {
    it('should return correct options for select function dropdown', () => {
      // Unfetched
  ...
  describe('_parseFunctionOptions', () => {
    it('should parse functions info to dropdown values', () => {
      this.formModel._functionsInfo = [
        { functionName: 'dep_ext_funk' },
  ...
  describe('._serializeFunctionArgs', () => {
    it('should set function_args to equal the arguments of the selected function', () => {
