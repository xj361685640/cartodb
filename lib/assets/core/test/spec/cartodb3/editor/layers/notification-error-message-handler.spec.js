...
describe('NotificationErrorHandler.extractErrorFromAnalysisNode', () => {
  it('should extract the right error message', () => {
  ...
  it('should replace the message with a more meaningful one', () => {
    var analysisDefinitionNodeModel = new cdb.core.Model({
      id: 'b1',
      error: {
  ...
  it('should return the same error if there isn\'t a replacement', () => {
    var analysisDefinitionNodeModel = new cdb.core.Model({
      id: 'b1',
      error: {
  ...
  it('should return the standard error if the analysis does not contain an error message', () => {
    var analysisDefinitionNodeModel = new cdb.core.Model({
      id: 'b1'
    });
    var errorMessage = NotificationErrorHandler.extractErrorFromAnalysisNode(analysisDefinitionNodeModel);
  ...
  it('should extract the error from a string', () => {
