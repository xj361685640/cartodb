...
describe('editor/layers/layer-content-view/infowindow/infowindow-click-model', () => {
  beforeEach(() => {
  ...
  it('should set template_name and template', () => {
  ...
  it('should empty fields if template is empty', () => {
  ...
  it('should transform template with headerColor if template is infowindow_color', () => {
    expect(this.model.get('template_name')).toEqual('');
    expect(this.model.get('template')).toEqual('');
