...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this._layer = this.collection.getLayerById(this.get('layer_id'))[0];

    this._layer.bind('change', this._toggleAutoStyle, this);
  },
  ...
  parse: function (r) {
    ...
    if (!_.isEmpty(r.style)) {
      ...
      if (style.auto_style) {
        ...
        attrs.auto_style_allowed = r.layerVisible;
      }
  ...
  _toggleAutoStyle: function () {
    this.set('auto_style_allowed', !this.get('auto_style_allowed'));
  },
