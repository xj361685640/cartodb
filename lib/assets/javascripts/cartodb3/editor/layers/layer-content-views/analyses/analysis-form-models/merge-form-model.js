...
module.exports = BaseAnalysisFormModel.extend({
  ...
  initialize: function () {
    ...
    this.on('change:source_geometry_selector', this._onChangeSourceGeometrySelector, this);
  ...
  _onChangeSourceGeometrySelector: function () {
    if (this.get('left_source') === this.get('source_geometry_selector')) {
      this.set('source_geometry', 'left_source');
    } else {
      this.set('source_geometry', 'right_source');
    }
  },
