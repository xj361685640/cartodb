<form>
  <div class="Editor-HeaderInfo">
    ...
    <div class="Editor-HeaderInfo-inner CDB-Text" data-fields="source">
      <div class="Editor-HeaderInfo-title u-bSpace--m">
        <h2 class="CDB-Text CDB-HeaderInfo-titleText CDB-Size-large"><%- _t('analyses.voronoi.title') %></h2>
      </div>
  ...
  <div class="Editor-HeaderInfo">
    ...
    <div class="Editor-HeaderInfo-inner CDB-Text" data-fields="buffer">
      <div class="Editor-HeaderInfo-title u-bSpace--m">
        <h2 class="CDB-Text CDB-HeaderInfo-titleText CDB-Size-large"><%- _t('editor.layers.analysis-form.parameters') %></h2>
      </div>
      <p class="CDB-Text u-upperCase CDB-FontSize-small u-altTextColor u-bSpace--xl"><%- _t('editor.layers.analysis-form.tune-params') %></p>
    </div>
  </div>
</form>
