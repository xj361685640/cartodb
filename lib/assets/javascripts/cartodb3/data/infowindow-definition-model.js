...
module.exports = Backbone.Model.extend({
  ...
  isCustomTemplate: function () {
    return this.get('template_name') && this.get('template_name') === 'custom';
  },

  setCustomTemplate: function (content) {
    this.set({
      template: content,
  ...
  wrongTemplate: function () {
    return !this.isCustomTemplate() && !this.TEMPLATES[this.get('template_name')];
  }
