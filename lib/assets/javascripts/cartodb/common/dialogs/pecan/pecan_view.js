...
module.exports = BaseDialog.extend({
  ...
  _analyzeStats: function(name, stats) {
    ...
    if (!stats.count) {
      console.log('Rejected because zero count', stats.count);
      return false;
    }

    if (stats.null_ratio > 75) {
      console.log('Rejected because the null ratio > 75: ', stats.null_ratio);
      return false;
    }
    ...
    if (distinctPercentage > 75) {
      console.log('Rejected because the distinctPercentage: ', distinctPercentage);
      return false;
    }
