...
module.exports = BaseDialog.extend({
  ...
  generateImage: function(url, retina) {
    ...
    this._loadMapImage(url, retina, callback.bind(this));
  },
  ...
  _loadMapImage: function(url, retina, callback) {
    var self = this;
    var mapImage = new Image();
    mapImage.crossOrigin = 'Anonymous';
    mapImage.onload = function() {
      self._mergeAnnotations(mapImage, retina, callback);
    };
    mapImage.src = url;
  },
  ...
  _mergeAnnotations: function(mapImage, retina, callback) {
