...
cdb.admin.ExportImageView = cdb.core.View.extend({
  ...
  _onImageCallback: function(error, url, retina) {
  ...
  _ok: function(e) {
    ...
    var retina = /* true || */ this.options.map.getBaseLayer().get('tileSize') === 512;
    ...
    .getUrl(function(err, url) {
      this._onImageCallback(err, url, retina)
    }.bind(this));
  },
