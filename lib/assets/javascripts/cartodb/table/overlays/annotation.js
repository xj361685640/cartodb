cdb.admin.overlays.Annotation = cdb.geo.ui.Annotation.extend({
    ...
    this.form_data = [{
        ...
        form: {
          ...
          'font-family-name': {
            type: 'select',
            value: "Helvetica",
            extra: ["Helvetica", "Droid Sans", "Vollkorn", "Roboto Slab", "Open Sans", "Lato", "Graduate", "Gravitas One", "Old Standard TT"]
          },
  ...
  _applyStyle: function() {
    ...
    else if (fontFamily  === "Roboto" || fontFamily === "Roboto Slab") fontFamilyClass = "roboto";
